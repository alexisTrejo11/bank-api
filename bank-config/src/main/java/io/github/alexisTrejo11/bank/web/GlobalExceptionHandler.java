package io.github.alexisTrejo11.bank.web;
...
/**
 * RFC 7807 {@link ProblemDetail} responses with an extra {@code errorCode}
 * property for machine clients.
 */
...
public class GlobalExceptionHandler {
	...
	private static ResponseEntity<ProblemDetail> build(HttpStatus status, String errorCode, String detail,
			WebRequest request) {

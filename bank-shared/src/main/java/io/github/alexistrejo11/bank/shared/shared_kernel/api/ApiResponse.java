package io.github.alexistrejo11.bank.shared.shared_kernel.api;
...
/**
 * Standard JSON body for REST APIs: {@code data} on success, {@code errors}
 * when the call failed logically.
 *

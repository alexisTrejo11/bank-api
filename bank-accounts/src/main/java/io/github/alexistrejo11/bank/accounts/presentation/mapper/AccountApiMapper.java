package io.github.alexistrejo11.bank.accounts.presentation.mapper;
...
import io.github.alexistrejo11.bank.accounts.presentation.dto.response.LedgerEntryResponse;
...
public final class AccountApiMapper {
	...
	public static OpenAccountResponse toOpenAccountResponse(OpenedAccount opened) {
	...
	public static LedgerPageResponse toLedgerPageResponse(PageResult<LedgerEntry> page) {
		List<LedgerEntryResponse> content = page.content()
				.stream()
				.map(AccountApiMapper::toLedgerEntryResponse)
				.toList();

...
/**
 * Posts ledger entries from transfer and loan streams (idempotency via
 * referenceId = eventId).
 */
@Component
...
public class AccountsKafkaConsumer {
	...
	@KafkaListener(topics = { BankKafkaTopics.TRANSFERS,
			BankKafkaTopics.LOANS }, groupId = "accounts-cg", containerFactory = "bankDomainEventKafkaListenerContainerFactory")

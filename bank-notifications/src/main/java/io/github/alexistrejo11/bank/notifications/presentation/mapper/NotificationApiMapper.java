package io.github.alexistrejo11.bank.notifications.presentation.mapper;

import io.github.alexistrejo11.bank.notifications.presentation.dto.response.NotificationRecordResponse;
import io.github.alexistrejo11.bank.notifications.presentation.dto.response.NotificationRecordsPageResponse;
import io.github.alexistrejo11.bank.notifications.presentation.dto.response.NotificationStatusCountResponse;
...
public final class NotificationApiMapper {
	...
	public static NotificationRecordsPageResponse toPageResponse(PageResult<NotificationLogRecord> page) {
		List<NotificationRecordResponse> content = page.content().stream().map(NotificationApiMapper::toRecordResponse)
				.toList();
